...
![01de1a8c5bb06f6f8e7a326778f65deb.png](en-resource://database/1087:1)
...
![c58c24b633d4097304dab74bf2d061e2.png](en-resource://database/1088:1)
...
![0cd576740eea6ee37baa1d5cda48409b.png](en-resource://database/1089:1)
...
![d70cfcf72aa14b5498e92599ef6b51e5.png](en-resource://database/1090:1)

#### AIO (Asynchronous I/O)

AIO 也就是 NIO 2。Java 7 中引入了 NIO 的改进版 NIO 2,它是异步 IO 模型。
异步 IO 是基于事件和回调机制实现的，也就是应用操作之后会直接返回，不会堵塞在那里，当后台处理完成，操作系统会通知相应的线程进行后续的操作。
![0d6e54514df242e9a9b6fa19f6ece25a.png](en-resource://database/1091:1)
...
![0b17057ae5a0ceffcd8aa16317ef9709.png](en-resource://database/1092:1)
...
![2d1938219e4ee344b331583866a6dc82.png](en-resource://database/1093:1)
...
![a09e614b3f6110e08078633a7b1bb489.png](en-resource://database/1094:1)
...
按操作方式分类结构图：
![08a43f0086bd0b2f2c6adbe12ba53203.png](en-resource://database/522:1)
按操作对象分类结构图：
![2539ba1fc433a54b14cebfc79019c2ba.png](en-resource://database/523:1)
# Java易错点
## 正确使用 equals 方法
...
![109190bbf3a45ec1ef6ece8d4eefd790.png](en-resource://database/524:1)
...
![5fff34c1c5e7cd17a4ecac457b5aa253.png](en-resource://database/525:1)
...
![f27a921ee4348292bf761b612c37e354.png](en-resource://database/526:1)
...
```
![2f0afcb854e2b99cb2404b5176b18152.png](en-resource://database/532:1)
...
![cad7ad875a42ed933fe3787b862cb61d.png](en-resource://database/527:1)
...
![0159594ac6bef19e7767545b8fe1eaa2.png](en-resource://database/528:1)

##### JDK1.8 之后

相比于之前的版本， JDK1.8 之后在解决哈希冲突时有了较大的变化，
当链表长度大于阈值（默认为 8）时，会首先调用 treeifyBin()方法。这个方法会根据 HashMap 数组来决定是否转换为红黑树，只有当数组长度大于或者等于 64 的情况下，才会执行转换红黑树操作，以减少搜索时间。否则，就是只是执行 resize() 方法对数组扩容。
![69e68abea6a89ccc02ae2daace9a3b43.png](en-resource://database/529:1)
...
![a9b3bcd29c6626fc05d09b6d58008b93.png](en-resource://database/533:1)
说明:上图有两个小问题：
...
##### JDK1.7（上面有示意图）
![c0d83b3c51df053e5058a8d0088bb32c.png](en-resource://database/530:1)
...
![34c2255ba6f430a44285e62fb3a05cfc.png](en-resource://database/534:1)
...
##### JDK1.8 
![df9681e93d162d74d5a17b056f198478.png](en-resource://database/531:1)
